...
HD_PWD='C:/Xilinx/Projects/MicroMips/MicroMips.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MicroMips.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MicroMips.tcl -notrace
