...
HD_PWD='C:/Xilinx/Projects/MicroMips/MicroMips.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MicroMips.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MicroMips.tcl
